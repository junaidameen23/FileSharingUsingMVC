...
using MyApplication.ApplicationUserHelper;
using System.IO;
...
namespace MyApplication.Controllers
{
    ...
    {
        private IRepository<ApplicationRole> applicationRoleRepository;
        private IRepository<Salutation> salutationRepository;
        private IRepository<FileDetails> fileDetailsRepository;
        ...
        public AccountController()
            : this(new UserManager<ApplicationUser>(new UserStore<ApplicationUser>(new ApplicationDbContext())),
                    new CurrentUser())
        {
            this.salutationRepository = new Repository<Salutation>(new ApplicationDbContext());
            this.applicationRoleRepository = new Repository<ApplicationRole>(new ApplicationDbContext());
            this.fileDetailsRepository = new Repository<FileDetails>(new ApplicationDbContext());
        }

        public AccountController(UserManager<ApplicationUser> userManager, ICurrentUser m_currentUser)
        {
        ...
        public ActionResult UploadFilePost(HttpPostedFileBase file)
        {
            ...
            if (file != null && file.ContentLength > 0)
            {
                ...
                var path = Path.Combine(Server.MapPath("~/FileStorage/"), fileName + "_" + DateTime.Now.ToString("yyyyMMddHHmmssfff"));

                fileDetails.FileName = fileName;
                fileDetails.Path = path;
                fileDetails.Extension = Path.GetExtension(path);
            ...
            fileDetailsRepository.Insert(fileDetails);
